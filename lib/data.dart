import 'AstrnomicalObject.dart';

List<AstronomicalObject> listOfObjects = [
  AstronomicalObject(
      name: "Sun",
      alternateNames: "Sol, Helios",
      volume: "1.41e+18 km3",
      mass: "1.988e+30 kg",
      ...
      info:
          ...
          "It is by far the most important source of energy for life on Earth. Its diameter is about 1.39 million kilometres (864,000 miles), or 109 times that of Earth, and its mass is about 330,000 times that of Earth. "
  ...
  AstronomicalObject(
      ...
      info:
          ...
          "Venus orbits the Sun every 224.7 Earth days. With a rotation period of 243 Earth days, it takes longer to rotate about its axis than any other planet in the Solar System by far, and does so in the opposite direction to all but Uranus (meaning the Sun rises in the west and sets in the east). "
  ...
  AstronomicalObject(
      name: "Earth",
      alternateNames: "Gaia, Gaea, Terra, Tellus, the World, the Globe",
      volume: "1.083e+12 km3",
      mass: "5.972e+24 kg",
      meanRadius: "6371 km",
      info:
  ...
  AstronomicalObject(
      name: "Uranus",
      alternateNames: "",
      volume: "6.833e+13 km3",
      mass: "8.681e+25 kg",
      meanRadius: "25362 km",
      info: "Uranus is the seventh planet from the Sun. "
